...
if !has('nvim')
    ...
    nnoremap <Leader>bg :w<CR>:TermExec cmd="gogovim && exit"<CR>
endif
...
function! InsertWarning()
    let l:logs = {
        ...
        \ 'html': 'console.warn("WARNING ' . g:warning_counter . ': Debug checkpoint");',
        \ 'template': 'console.warn("WARNING ' . g:warning_counter . ': Debug checkpoint");',
